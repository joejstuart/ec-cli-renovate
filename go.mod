...
require (
	...
	github.com/testcontainers/testcontainers-go v0.35.0 // using unreleased version that contains the fix in https://github.com/testcontainers/testcontainers-go/pull/2899
